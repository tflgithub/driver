...
/**
 * Created by tfl on 15/10/8.
 */
@SuppressLint("NewApi")
public class AlertView {
    public static enum Style {
        ActionSheet, Alert, ListAlert
    }
    ...
    public AlertView(String title, String msg, Drawable msgDrawable,
                     String cancel, String[] destructive, String[] others,
        ...
        initData(title, msg, msgDrawable, cancel, destructive, others);
        initViews();
        init();
        initEvents();
    }
     ...
     * 获取数据
     */
    protected void initData(String title, String msg, Drawable msgDrawable,
                            String cancel, String[] destructive, String[] others) {

        this.title = title;
        this.msg = msg;
        this.msgDrawable = msgDrawable;
        if (destructive != null) {
    ...
    protected void initViews() {
        ...
        switch (style) {
            ...
            case ListAlert:
                ...
                contentContainer.setLayoutParams(params);
                gravity = Gravity.CENTER;
                initListAlertViews(layoutInflater);
                break;
        }
    }
    ...
    protected void initHeaderView(ViewGroup viewGroup) {
        ...
        if (msgDrawable != null) {
            ...
            tvAlertMsg.setBackgroundDrawable(msgDrawable);
        }
    }
    ...
    protected void initListView() {
        ...
        // 把cancel作为footerView
        if (cancel != null && style == Style.Alert || style==Style.ListAlert) {
    ...
    protected void initListAlertViews(LayoutInflater layoutInflater) {
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(
