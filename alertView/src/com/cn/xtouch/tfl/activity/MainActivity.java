package com.cn.xtouch.tfl.activity;
...
import com.cn.xtouch.tfl.alert.R;
...
public class MainActivity extends Activity implements OnItemClickListener, OnDismissListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAlertView = new AlertView("标题", "内容",null, "取消", new String[]{"确定"}, null, this, AlertView.Style.Alert, this).setCancelable(true).setOnDismissListener(this);
        //拓展窗口
        mAlertViewExt = new AlertView("提示", "请完善你的个人资料！", null,"取消", null, new String[]{"完成"}, this, AlertView.Style.Alert, this);
    ...
    public void alertShow2(View view) {
        new AlertView("标题", "内容",null, null, new String[]{"确定"}, null, this, AlertView.Style.Alert, this).show();
    }

    public void alertShow3(View view) {
        new AlertView(null, null, null,null, new String[]{"高亮按钮1", "高亮按钮2", "高亮按钮3"},
    ...
    public void alertShow4(View view) {
        new AlertView("标题", null,null, "取消", new String[]{"高亮按钮1"}, new String[]{"其他按钮1", "其他按钮2", "其他按钮3"}, this, AlertView.Style.ActionSheet, this).show();
    }

    public void alertShow5(View view) {
        new AlertView("标题", "内容", null,"取消", null, null, this, AlertView.Style.ActionSheet, this).setCancelable(true).show();
    }

    public void alertShow6(View view) {
        new AlertView("上传头像", null,null, "取消", null,
                new String[]{"拍照", "从相册中选择"},
                this, AlertView.Style.ActionSheet, this).show();
    }
    
    public void alertShow7(View view) {
    	new AlertView("标题", null,getResources().getDrawable(R.drawable.ic_launcher), null, new String[]{"确定"}, null, this, AlertView.Style.Alert, this).show();
    }
